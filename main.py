...
from picker_flow import start_picker, handle_occasion, handle_color
...
async def handle_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "catalog":
        await query.edit_message_text("Каталог скоро будет")

    elif query.data == "choose_bouquet":
        await start_picker(update, context)

    elif query.data == "consultation":
        await query.edit_message_text("Флорист скоро свяжется")
